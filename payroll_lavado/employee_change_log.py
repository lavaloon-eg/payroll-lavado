...
def create_employee_change_log(employee_id: str, source_doctype: str, source_id: str):
    ...
    if source_doctype.lower() == "salary structure assignment":
        ...
        salary_structure_assignments = frappe.get_all("Salary Structure Assignment", filters={
            ['employee', '=', employee_id], ['company', '=', employee_doc.company]}
    ...
    employee_change_log_record.salary_structure_assignment = salary_structure_doc.name
    employee_change_log_record.hour_rate = salary_structure_doc.salary_structure_hour_rate or 0
